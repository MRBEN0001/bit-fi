        ...
        <div class="container">
            <div class="row d-md-flex justify-content-md-center gx-lg-5">
                <div class="col-12 col-md-10 col-lg-6 pe-lg-5">
                    ...
                    <form id="contact-form" method="post" action="/contact-us" class="row g-1 mt-2" novalidate="">
                        @csrf
                        <div class="col-6">
                        ...
                        <div class="col-12">
                            <textarea class="form-control" id="message" name="body" placeholder="Message" rows="6" required=""></textarea>
                        </div>
                        <div class="d-grid">
                            <button class="btn btn-primary rounded-pill" type="submit" name="submit">Send Message</button>
                        </div>
                    </form>
                            ...
                            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2 mt-1 gx-lg-0">
                                <div class="col mb-2 mb-md-0 mb-lg-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p class="mb-0">support@ggraton.com</p>
                                    </div>
                                </div>
                                <!-- <div class="col">
                                    <div class="d-flex align-items-center">
